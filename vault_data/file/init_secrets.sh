...
OAUTH_GITHUB_STATE=$(vault write -f -field=random_bytes sys/tools/random/32 | base64)
...
vault kv put secret/oauth OAUTH_42_CLIENT_ID=$OAUTH_42_CLIENT_ID OAUTH_42_CLIENT_SECRET=$OAUTH_42_CLIENT_SECRET OAUTH_42_STATE=$OAUTH_42_STATE OAUTH_GITHUB_CLIENT_ID=$OAUTH_GITHUB_CLIENT_ID OAUTH_GITHUB_CLIENT_SECRET=$OAUTH_GITHUB_CLIENT_SECRET OAUTH_GITHUB_STATE=$OAUTH_GITHUB_STATE
