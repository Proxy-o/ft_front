...
export default function Nav() {
  ...
  return (
    <div className=" group flex flex-col gap-4 py-2 h-screen shadow-lg md:w-[9rem] overflow-y-auto no-scrollbar bg-white bg-opacity-50 dark:bg-black dark:bg-opacity-50">
