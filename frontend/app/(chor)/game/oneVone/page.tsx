...
export default function Page() {
  return (
    <>
      <div className="flex flex-col p-4 lg:flex-row w-full h-full justify-center items-start gap-2 top-0">
        <Card className="w-11/12 max-w-[900px] h-fit flex flex-col justify-center items-start gap-4 p-4">
          <div className="w-full h-fit">
            <Two type="two" />
          </div>
        </Card>
        <div className="w-11/12 lg:w-4/12 h-fit flex flex-col justify-start items-start gap-2">
